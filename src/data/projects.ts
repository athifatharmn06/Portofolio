...
export const projectsData: ProjectData[] = [
  ...
  },
  {
    ...
    thumbnail: "/projects/NFCC - Digital Twin/Screenshot 2026-05-28 014717.png",
    ...
    demoUrl: undefined,
    photos: [
      { url: "/projects/NFCC - Digital Twin/Screenshot 2026-05-28 014717.png", caption: "Main dashboard — 3D holographic building view with 5,000 sensor nodes rendered via InstancedMesh at 60fps.", tools: "Three.js, React Three Fiber, Bloom Post-Processing" },
      { url: "/projects/NFCC - Digital Twin/Screenshot 2026-05-28 014727.png", caption: "Division 01 — Komando Utama: threat level gauge, risk matrix 5×5, and system-wide status overview.", tools: "React, Zustand, Recharts" },
      { url: "/projects/NFCC - Digital Twin/Screenshot 2026-05-28 014735.png", caption: "Division 02 — Keamanan Dalam: AI heatmap overlay with K-Means clustering for anomaly detection.", tools: "K-Means Algorithm, Web Workers, Canvas" },
      { url: "/projects/NFCC - Digital Twin/Screenshot 2026-05-28 014747.png", caption: "Division 03 — Pertahanan Perimeter: phosphor radar with 5-trail afterglow and drone patrol status.", tools: "CSS Animations, SVG, React" },
      { url: "/projects/NFCC - Digital Twin/Screenshot 2026-05-28 014754.png", caption: "Division 04 — Ketenagalistrikan: dynamic load flow chart, UPS battery status, and ATS control.", tools: "Recharts, PLN 220V/50Hz Simulation" },
      { url: "/projects/NFCC - Digital Twin/Screenshot 2026-05-28 014801.png", caption: "Division 05 — HVAC & Mekanikal: PID controller with Kp/Ki/Kd sliders and temperature response chart.", tools: "PID Simulation, Recharts, Physics Worker" },
      { url: "/projects/NFCC - Digital Twin/Screenshot 2026-05-28 014810.png", caption: "Division 06 — Keselamatan Kebakaran: smoke detector grid, fire spread monitor, and evacuation routes.", tools: "A* Pathfinding, SVG Floor Plan" },
      { url: "/projects/NFCC - Digital Twin/Screenshot 2026-05-28 014818.png", caption: "Division 07 — Plumbing & Sanitasi: animated water tank levels, pipe flow diagram, and water quality metrics.", tools: "Mass Balance Simulation, SVG, CSS Animations" },
      { url: "/projects/NFCC - Digital Twin/Screenshot 2026-05-28 014826.png", caption: "Division 08 — Layanan Medis: first aid station map, isolation room status, and emergency dispatch.", tools: "React, Zustand, Web Audio API" },
      ...
      { url: "/projects/NFCC - Digital Twin/Screenshot 2026-05-28 015141.png", caption: "ISO/IEC/NFPA compliance matrix — 15 international standards self-assessed and documented interactively.", tools: "ISO 16484, IEC 62443, NFPA 3000, ISO 27001" },
    ],
  },
  {
    id: "p8",
