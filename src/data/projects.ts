...
export const projectsData: ProjectData[] = [
  {
    id: "p7",
    title: "NFCC Digital Twin",
    category: "Web & Simulation",
    thumbnail: "/projects/NFCC - Digital Twin/Screenshot 2026-05-28 015141.png",
    shortDesc: "A fully client-side digital twin simulating a national critical infrastructure command center — 5,000 sensor nodes at 60fps, 11 division dashboards, multi-threaded Web Workers, and 3D holographic visualization. Zero backend, all computation in the browser.",
    techStack: ["React", "TypeScript", "Three.js", "React Three Fiber", "Web Workers", "Zustand", "Dexie.js", "Vite", "Tailwind CSS", "Framer Motion", "GSAP", "Recharts", "fast-check"],
    githubUrl: "https://github.com/athifatharmn06/nfcc-digital-twin",
    demoUrl: undefined,
    photos: [
      { url: "/projects/NFCC - Digital Twin/Screenshot 2026-05-28 015141.png", caption: "Main board — ISO/IEC/NFPA compliance matrix with 15 international standards self-assessed and documented interactively.", tools: "ISO 16484, IEC 62443, NFPA 3000, ISO 27001" },
      { url: "/projects/NFCC - Digital Twin/Screenshot 2026-05-28 014717.png", caption: "Division 01 — Komando Utama: 3D holographic building view with 5,000 sensor nodes rendered via InstancedMesh at 60fps.", tools: "Three.js, React Three Fiber, Bloom Post-Processing" },
      { url: "/projects/NFCC - Digital Twin/Screenshot 2026-05-28 014727.png", caption: "Division 02 — Keamanan Dalam: AI heatmap overlay with K-Means clustering for anomaly detection.", tools: "K-Means Algorithm, Web Workers, Canvas" },
      { url: "/projects/NFCC - Digital Twin/Screenshot 2026-05-28 014735.png", caption: "Division 03 — Pertahanan Perimeter: threat level gauge, risk matrix 5×5, and system-wide status overview.", tools: "React, Zustand, Recharts" },
      { url: "/projects/NFCC - Digital Twin/Screenshot 2026-05-28 014747.png", caption: "Division 04 — Ketenagalistrikan: phosphor radar with 5-trail afterglow and drone patrol status.", tools: "CSS Animations, SVG, React" },
      { url: "/projects/NFCC - Digital Twin/Screenshot 2026-05-28 014754.png", caption: "Division 05 — HVAC & Mekanikal: dynamic load flow chart, UPS battery status, and ATS control.", tools: "Recharts, PLN 220V/50Hz Simulation" },
      { url: "/projects/NFCC - Digital Twin/Screenshot 2026-05-28 014801.png", caption: "Division 06 — Keselamatan Kebakaran: PID controller with Kp/Ki/Kd sliders and temperature response chart.", tools: "PID Simulation, Recharts, Physics Worker" },
      { url: "/projects/NFCC - Digital Twin/Screenshot 2026-05-28 014810.png", caption: "Division 07 — Plumbing & Sanitasi: smoke detector grid, fire spread monitor, and evacuation routes.", tools: "A* Pathfinding, SVG Floor Plan" },
      { url: "/projects/NFCC - Digital Twin/Screenshot 2026-05-28 014818.png", caption: "Division 08 — Layanan Medis: animated water tank levels, pipe flow diagram, and water quality metrics.", tools: "Mass Balance Simulation, SVG, CSS Animations" },
      { url: "/projects/NFCC - Digital Twin/Screenshot 2026-05-28 014826.png", caption: "Division 09 — Logistik & Operasional: first aid station map, isolation room status, and emergency dispatch.", tools: "React, Zustand, Web Audio API" },
      { url: "/projects/NFCC - Digital Twin/Screenshot 2026-05-28 014838.png", caption: "Division 10 — Operasi Siber: SIEM terminal with auto-scrolling logs and IEC 62443 network zone visualization.", tools: "IEC 62443, CSS Terminal Animation" },
      { url: "/projects/NFCC - Digital Twin/Screenshot 2026-05-28 014855.png", caption: "Division 11 — Komunikasi Krisis: broadcast message panel, siren control via Web Audio API, and PA zone map.", tools: "Web Audio API, OscillatorNode, SVG" },
    ],
  },
  {
    id: "p8",
    title: "URLSiap — Web Audit Platform",
    category: "Web & AI Integration",
    thumbnail: "/projects/URLSiap/heropgae.png",
    shortDesc: "A production-oriented micro-tool for technical SEO, Schema Markup, and web performance auditing. Features progressive async fetching, SSRF hardening, persistent job tracking via Supabase, and Fail-Soft UX for network failures.",
    techStack: ["Next.js", "TypeScript", "Supabase", "Tailwind CSS", "Framer Motion", "Zod", "Cheerio", "shadcn/ui", "Google PageSpeed API"],
    githubUrl: undefined,
    demoUrl: undefined,
    photos: [
      { url: "/projects/URLSiap/heropgae.png", caption: "Hero landing page — clean entry point for URL input with instant audit trigger and progressive loading UX.", tools: "Next.js, Tailwind CSS, Framer Motion" },
      { url: "/projects/URLSiap/resultpage.png", caption: "Audit result page — comprehensive SEO health report with scored categories and actionable recommendations.", tools: "Next.js App Router, Zod, Cheerio" },
      { url: "/projects/URLSiap/health summary.png", caption: "Health summary panel — at-a-glance scoring across SEO, performance, schema, and accessibility dimensions.", tools: "Google PageSpeed API, Supabase" },
      { url: "/projects/URLSiap/detail review.png", caption: "Detailed review section — deep-dive into individual audit findings with severity levels (High/Medium/Low).", tools: "HTML Header Parsing, Canonical Conflict Detection" },
      { url: "/projects/URLSiap/action plan.png", caption: "Action plan panel — prioritized fix recommendations generated from audit findings for immediate implementation.", tools: "Zod Validation, Next.js Server Actions" },
      { url: "/projects/URLSiap/pagespeed insight.png", caption: "PageSpeed Insights integration — Core Web Vitals and CrUX field data rendered alongside fast-audit results.", tools: "Google PSI API, CrUX Data" },
      { url: "/projects/URLSiap/about us.png", caption: "About page — platform overview explaining the audit methodology, scope guarantees, and non-goals.", tools: "Next.js, shadcn/ui" },
      { url: "/projects/URLSiap/snippet 1.png", caption: "Code snippet — SSRF hardening implementation with DNS resolution safeguards and per-hop redirect validation.", tools: "TypeScript, Node.js Fetch API" },
      { url: "/projects/URLSiap/snippet 2.png", caption: "Code snippet — persistent job state tracker with Supabase atomic operations and RAM fallback for DB downtime.", tools: "Supabase, PostgreSQL, TypeScript" },
      { url: "/projects/URLSiap/snippet 3.png", caption: "Code snippet — robust Schema.org JSON-LD validator handling nested arrays and @graph structures without UI crash.", tools: "fast-xml-parser, Zod, TypeScript" },
    ],
  },
  {
    id: "p0",
